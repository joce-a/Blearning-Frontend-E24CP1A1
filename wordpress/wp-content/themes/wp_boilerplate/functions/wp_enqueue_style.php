...
function dl_enqueue_style() {
	...
	wp_register_style( 'main', get_theme_file_uri( 'assets/css/main.css'), null, null, 'screen');
	wp_register_style( 'nivo-slider', get_theme_file_uri( 'assets/css/nivo-slider.css'), null, null, 'screen');
	wp_register_style( 'nivotheme', get_theme_file_uri( 'assets/css/nivotheme.css'), null, null, 'screen');
	wp_register_style( 'prettyPhoto', get_theme_file_uri( 'assets/css/prettyPhoto.css'), null, null, 'screen');	
	...
	wp_enqueue_style( 'main', 'nivo-slider', 'nivotheme', 'prettyPhoto' );
