...
function dl_enqueue_scripts() {
	...
	wp_register_script( 'jquery.prettyPhoto', get_theme_file_uri('/assets/js/jquery.prettyPhoto.js'), $deps, null, true );
	wp_register_script( 'jquery.quicksand', get_theme_file_uri('/assets/js/jquery.quicksand.js'), $deps, null, true );
	wp_register_script( 'jquery.nivo.slider.pack', get_theme_file_uri('/assets/js/jquery.jquery.nivo.slider.pack.js'), $deps, null, true );
	...
	wp_enqueue_script( 'main_js', 'jquery.prettyPhoto', 'jquery.quicksand', 'jquery.nivo.slider.pack');
